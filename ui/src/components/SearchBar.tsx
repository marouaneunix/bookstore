...
const SearchBar = ({ onSubmit }: Props) => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" onChange={(e) => setCategory(e.target.value)} placeholder="Search for books by category..."
                className="border border-gray-400 rounded p-2 mr-4 mb-4 w-2/5 focus:outline-none focus:border-blue-500" />

            <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-6 rounded-lg mr-4" type='submit'>Search</button>
